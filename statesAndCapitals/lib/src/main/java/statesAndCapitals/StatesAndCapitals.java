...
public class StatesAndCapitals
{
    ...
    public void testStatesAndCapitals() throws IOException
    {
        ...
        Boolean doAllStatesHaveAnAnthem = states.stream().allMatch(stateInfo -> stateInfo.getStateAnthem().compareTo(stateInfo.getStateAnthem())>0);
        ...
        Boolean doNoStatesHaveAOneWordMotto = states.stream().noneMatch(stateInfo -> stateInfo.getStateMotto().split(" ").length == 1);
